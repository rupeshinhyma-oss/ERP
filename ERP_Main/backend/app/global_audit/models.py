...
class AuditEventType(str, Enum):
    ...
    ERP_SWITCH_FAILED = "ERP_SWITCH_FAILED"
    PROVISIONING_AUTH_FAILED = "PROVISIONING_AUTH_FAILED"
    ...
    # Bidirectional Identity Linking & Central Provisioning (Prompt 2 / Phase 5)
    ...
    PROVISIONING_RETRY_SCHEDULED = "PROVISIONING_RETRY_SCHEDULED"

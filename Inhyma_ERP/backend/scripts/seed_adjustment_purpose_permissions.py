"""
Seed adjustment purposes permissions:
- adjustment_purpose.view
- adjustment_purpose.create
- adjustment_purpose.update
- adjustment_purpose.delete
- adjustment_purpose.export
- adjustment_purpose.import
- adjustment_purpose.bulk_action
...
async def seed_permissions() -> None:
    ...
    async with session_factory() as session:
        ...
        print("Adjustment purposes permissions successfully seeded and granted to roles.")

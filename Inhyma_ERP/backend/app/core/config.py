...
class Settings(BaseSettings):
    ...
    # -------------------------------------------------------------------
    # ERP Identity (Multi-ERP Platform, Phase 3)
    # -------------------------------------------------------------------
    # This ERP instance's own stable, machine-readable identity within the
    # multi-ERP ecosystem (ERP_Main's control plane / ERP Registry).
    ...
    # It exists so a *future* SSO/federation integration point, and the
    # Phase 3 ERP service-identity/heartbeat integration, have exactly
    # one place to read "which ERP am I" from, rather than that value
    # being hardcoded or scattered across source files.
    #
    ...
    # docs/MULTI_ERP_ARCHITECTURE.md §4 (in Yinglima_ERP) and
    # docs/INHYMA_AUDIT.md for the full disambiguation.
    ERP_KEY: str = "inhyma"

"""Company Categories Pydantic Schemas."""
...
class CompanyCategoryBase(BaseModel):
    name: str = Field(..., min_length=1, max_length=100, description="Company category name")
    business_type: str = Field(default="B2B", min_length=1, max_length=50, description="Business classification type, e.g. B2B or B2C")

"""Company Sectors Row Validators for bulk import."""
...
def validate_company_sector_row(row: dict, row_num: int) -> dict:
    """Validate and normalize a raw CSV/Excel row for Company Sectors import."""

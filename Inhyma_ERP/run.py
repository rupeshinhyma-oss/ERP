"""
Inhyma ERP (India Distribution) Standalone Runner.
Launches and supervises backend and frontend services for Inhyma ERP.
...
def shutdown_all():
    ...
    if shutting_down:
        return
    shutting_down = True
    print(f"\n{YELLOW}{BOLD}[RUNNER] Stopping Inhyma ERP services...{RESET}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Inhyma ERP Standalone Runner")

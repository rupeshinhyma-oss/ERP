 ...
 * every time. Deliberately minimal -- this is not a query engine, just
 * get/put/delete/getAll/getAllByIndex/count, which is everything the
 * rest of Phase 2 needs.
 */
...
/** Delete every record in a store. Used for logout cleanup (Section 13) and test resets. */

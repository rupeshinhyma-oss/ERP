/**
 * Realtime Event & Data Layer Integration (Phase 8C, Sections 11-14 / Phase 9).
 *
 * Integrates Yinglima's existing WebSocket live events (`lib/live/`) with
 * the IndexedDB local cache and Sync Manager:
 *
 *   WebSocket event
 *         ↓

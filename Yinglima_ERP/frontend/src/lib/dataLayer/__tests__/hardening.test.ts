/**
 * Yinglima Browser Data Layer: Phase 8C-A / Phase 9 Hardening Test Suite
 *
...
beforeEach(async () => {
  ...
  shutdownDataLayer();
  closeDatabase();
  configureDataLayer("yinglima_hardening_test");
  await import("../context").then((m) => m.wipeAllStores());
  localStorage.clear();
  vi.clearAllMocks();
});

describe("Phase 8C-A / Phase 9: Stuck PROCESSING State Recovery", () => {
...
describe("Phase 8C-A / Phase 9: User Isolation & Session Security", () => {
...
describe("Phase 8C-A / Phase 9: Realtime liveClient Integration", () => {
  it("wires liveClient events to cache and handles updates & deletions", async () => {
    initDataLayer("yinglima_hardening_test");
...
describe("Phase 8C-A / Phase 9: Version Comparison Hardening", () => {
...
describe("Phase 8C-A / Phase 9: Tab Lock Hardening", () => {

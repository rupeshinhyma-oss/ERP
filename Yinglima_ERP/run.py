"""
Yinglima ERP (China Procurement) Standalone Runner.
Launches and supervises backend and frontend services for Yinglima ERP.
...
def shutdown_all():
    ...
    if shutting_down:
        return
    shutting_down = True
    print(f"\n{YELLOW}{BOLD}[RUNNER] Stopping Yinglima ERP services...{RESET}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Yinglima ERP Standalone Runner")

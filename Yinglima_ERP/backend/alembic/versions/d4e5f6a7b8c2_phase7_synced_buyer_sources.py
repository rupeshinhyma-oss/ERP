"""phase7 synced buyer sources (local idempotency for bidirectional buyer.created cross-ERP sync)

Revision ID: d4e5f6a7b8c2
Revises: c3d4e5f6a7b1
Create Date: 2026-09-10

Phase 7: adds synced_buyer_sources to Yinglima, mirroring the identical
table Phase 6 already added to Inhyma -- tracking which local Buyer row
a given (source_erp_id, source_buyer_id) has already been synchronized
into, for the new Inhyma -> Yinglima sync direction this phase adds.
Purely additive.
"""
